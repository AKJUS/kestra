...
class SwitchTest {
    ...
    void switchFirst() throws TimeoutException, QueueException {
        ...
        assertThat(execution.findTaskRunsByTaskId("parent-seq").getFirst().getOutputs().get("defaults")).isFalse();
    }
    ...
    void switchDefault() throws TimeoutException, QueueException {
        ...
        assertThat(execution.findTaskRunsByTaskId("parent-seq").getFirst().getOutputs().get("defaults")).isTrue();
    }
